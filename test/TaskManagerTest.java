...
abstract class TaskManagerTest<T extends TaskManager> {
    ...
    @Test
    void calculationOfTheEpicStatusWithAnEmptyListOfSubtasks() {
    ...
    @Test
    void calculationOfTheEpicStatusWithSubtasksWithTheNEWStatus() {
        Epic testEpic = new Epic();
        taskManager.addEpic(testEpic);
    ...
    @Test
    void calculationOfTheEpicStatusWithSubtasksWithTheDONEStatus() {
        Epic testEpic = new Epic();
        taskManager.addEpic(testEpic);
        SubTask sb1 = new SubTask();
        sb1.setEpicId(1);
    ...
    @Test
    void calculationOfTheEpicStatusWithSubtasksWithTheDONEAndNEWStatus() {
        Epic testEpic = new Epic();
        taskManager.addEpic(testEpic);
        SubTask sb1 = new SubTask();
        sb1.setEpicId(1);
    ...
    @Test
    void calculationOfTheEpicStatusWithSubtasksWithTheIN_PROGRESSStatus() {
        Epic testEpic = new Epic();
        taskManager.addEpic(testEpic);
        SubTask sb1 = new SubTask();
        sb1.setEpicId(1);
    ...
    void getEpicById() {
        ...
        assertNotNull(taskManager.getEpicById(1), "Задача не найдена");
    }
